...
public class GameViewer extends JComponent {
	...
	String speed = "Use I to increase speed and K to decrease speed. Current Speed: 10";
	private static final int TEXT_X = 200;
	private static final int TEXT_X2 = 50;
	 ...
	 */
	public void reset() {
		p = new Player(new Rectangle(DATester.X_START, DATester.Y_START, DATester.SIDE_LENGTH, DATester.SIDE_LENGTH),
				DATester.SPEED);
		Obstacle.boundingRect = new ArrayList<>();
		for (Obstacle o : movingO.keySet())
			resetObstacle(o);
	...
	public void level1(Graphics2D g2) {
		...
		g2.drawString(speed, TEXT_X2, TEXT_Y3 + 30);
	}
