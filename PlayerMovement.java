	...
	public void keyPressed(KeyEvent e) {
		...
		if (code == KeyEvent.VK_I) {
			if (t.getDelay() != 0) {
				...
				if (t.getDelay() == 0) {
					game.speed = "Use I to increase speed and K to decrease speed. Current Speed: 20(Max)";
				} else {
					game.speed = "Use I to increase speed and K to decrease speed. Current Speed: "
							+ (20 - t.getDelay());
				}
			}
		}
		if (code == KeyEvent.VK_K) {
			if (t.getDelay() != 19) {
				t.setDelay(t.getDelay() + 1);
				if (t.getDelay() == 19) {
					game.speed = "Use I to increase speed and K to decrease speed. Current Speed: 1(Min)";
				} else {
					game.speed = "Use I to increase speed and K to decrease speed. Current Speed: "
							+ (20 - t.getDelay());
				}
